...
for i = 1:segments(2)
    ...
    [S,frames_out(i).F,frames_out(i).t_for_spect] = stft(frames_out(i).ProcessedSig,Fs, ...
    ...
    [~,Frames_with_vocal_phoneme] = FindWordIdx(frames_out(i).FramedSig,Fs,Param.WindowLength,Param.Overlap);
