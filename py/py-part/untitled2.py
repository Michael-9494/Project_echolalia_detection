...
if __name__ == '__main__':
    # "C:\Users\97254\Documents\GitHub\Project-speech\py\py-part\FMP_1.2.3"
    path_filename = os.path.join('C', r"\Users\97254\Documents\GitHub\Project-speech\py\py-part\New folder\675830557_170820_new.xlsx")
    path_filename_wav = os.path.join('C', r"\Users\97254\Documents\GitHub\Project-speech\py\py-part\New folder\675830557_170820.wav")
    df = pd.read_excel(path_filename, sheet_name='Sheet1', index_col=None, header=None)
    print(df.info())
    ...
    EcholaliaEventTherapistStart = df[(df[3] == "Echolalia") & (df[2] == "Therapist")][:][0]
    # print("\n\nEcholalic Therapist events start\n\n\n", EcholaliaEventTherapistStart)

    EcholaliaEventTherapistEnd = df[(df[3] == "Echolalia") & (df[2] == "Therapist")][:][1]
    ...
    alpha=0.97;
    WindowLength_time=30*10**-3;  # 30 [mS] window
